...
client.on('ready', () => {
  ...
  client.user.setActivity('We all hate summer underwood', {
    type: "STREAMING",
...
client.on('message', async message => {
  ...
  if (command === 'twitter') {
    ...
    message.channel.send(`Her personality is perfect at least to me it is. She's a 10/10 tbh. me and her against this stupid world forever<33`)
    ...
    const embed = new Discord.MessageEmbed()
      .setTitle(`Anna's favorite songs<3`)
      .setColor('#FF33EA')
      .addFields(
        {
          name: 'Mood ring by Lorde',
          value: `https://www.youtube.com/watch?v=P103bWMdvtA`,
        },
        {
          name: `Surprise party by hoodie Allen (Featuring: Blackbear)`,
          value: `https://www.youtube.com/watch?v=gU0bFlYFrOg`,
        },
      )
      .setTimestamp();
    message.channel.send(embed)
    ...
    const embed = new Discord.MessageEmbed()
      ...
      .addFields(
        ...
        {
          name: '+slap',
          value: `Slaps someone. Usage "+slap @user"`,
        },
        {
          name: '+rate',
        ...
        {
          name: '+switchblades',
          value: `Sends the link for the song witchblades by lil peep and lil tracy`,
        },
        {
          name: '+gideon',
          value: `Sends all the creepy things Gideon Coone has said. lmao`,
        },
        {
          name: '+favsongs',
    ...
    const embed = new Discord.MessageEmbed()
      ...
      .setFooter(`Created By: ${message.author.tag}`, message.author.displayAvatarURL())
    message.channel.send(embed)
  } else if (command == 'switchblades') {
    message.channel.send('https://www.youtube.com/watch?v=E7sP6t1QyrI')
  } else if (command == 'gideon') {
    const embed = new Discord.MessageEmbed()
      .setThumbnail("https://cdn.discordapp.com/attachments/889598143426101298/891011059215917106/1190978563_2261111954595ugly_man_400x400.png")
      .setTitle('Quotes by Gideon')
      .setColor('RANDOM')
      .addFields(
        {
          name: '8/19/2021',
          value: `"I wonder if you hit puberty yet" - Gideon Coone`,
        },
        {
          name: `9/2/2021`,
          value: `"I wonder when girls get their boobs" - Gideon Coone`,
        },
        {
          name: '9/2/2021',
          value: `"Do you mind turning your webcam on?? 🥺🥺 I mean I'm NOT FORCING YOU to turn it on I'm JUST ASKING SIMPLY THAT YOU TURN IT ON😡😡😡" - Gideon Coone`,
        },
        {
          name: '9/2/2021',
          value: `"I just had a thought I'm not gonna say it because it was about a womens private parts" - Gideon Coone`,
        },
        {
          name: '9/2/2021',
          value: `"do you like me??? because it seems like you do :pleading_face::smiling_face_with_3_hearts:" - Gideon Coone`,
        },
        {
          name: '9/3/2021',
          value: `"I told my parents about all my friends but you because if they find out im talking to a girl they'll freak out... they're probably jealous because I'm talking to a girl like you" - Gideon Coone`,
        },
        {
          name: '9/3/2021',
          value: `"I don't know how to make a girl happy so I don't see why anyone would like me" - Gideon Coone`,
        },
        {
          name: '9/28/2021',
          value: `*chews while literally on mic in class* - Gideon Coone`,
        },
        {
          name: 'Now go to your corner and fucking cry Gideon.',
          value: `https://www.youtube.com/watch?v=C_dHR-F6RQ0`,
        },
      )
      .setFooter('Creepy quotes by Gideon Coone')
      .setTimestamp();
    message.channel.send(embed)
  } else if (command == 'slap') {
    let user = message.mentions.users.first() || message.author
    message.channel.send('https://tenor.com/view/slap-in-the-face-slap-hit-ouch-anger-gif-17283089').then(() => {
      message.channel.send(`<@${message.author.id}> slapped <@${user.id}>`)
    })
  } else if (command == 'summer') {
    const embed = new Discord.MessageEmbed()
      .setImage('https://cdn.discordapp.com/attachments/875552601830199350/904290515745386496/Screen_Shot_2021-10-03_at_4.01.13_PM.png')
      .setTitle(`The most retarded and annoying girl alive.`)
      .setColor('RANDOM')
      .setFooter(`She's so fucking annoying I swear.`)
      .setTimestamp();
    message.channel.send(embed)
  } else if (command == 'abby') {
    const embed = new Discord.MessageEmbed()
      .setImage('https://cdn.discordapp.com/attachments/758420628109525053/907400983049556028/Screen_Shot_2021-11-01_at_9.15.00_AM.png')
      .setTitle(`The second most retarded and annoying girl alive.`)
      .setColor('RANDOM')
      .setFooter(`She's so fucking annoying I swear.`)
      .setTimestamp();
    message.channel.send(embed)
